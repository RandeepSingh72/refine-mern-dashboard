...
const PropertyCard = ({id, title, price, location, photo}: PropertyCardProps) => {
  ...
  return (
    ...
    sx={{
      ...
      padding: '10px',
      '&:hover':{
        boxShadow: '0 22px 45px 2px rgba(112, 112, 112, 0.1)'
      },
      cursor:'pointer',
    ...
    elevation={0}
    >
      <CardMedia component='img' width='100%' height={210} image={photo} alt="card" sx={{borderRadius:'10px'}} />
